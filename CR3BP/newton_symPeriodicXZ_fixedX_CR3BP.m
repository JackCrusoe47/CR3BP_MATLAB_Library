function [SV0,tf] = newton_symPeriodicXZ_fixedX_CR3BP(SV0_0,tf_0,mu,tol)
% =======================================================================
%   Newton-Raphson Method To Estimate Initial Condtion For Periodic
%       Orbit Symmetric Across XZ plane with X-position Fixed
%                  Variable Z-position and Y-Velocity
% =======================================================================
%
...
%
% Format : [SV0,tf] = newton_symPeriodicXZ_fixedX_CR3BP(SV0_0,tf_0,mu,tol)
%
% -----------------------------------------------------------------------
%                               INPUTS
% -----------------------------------------------------------------------
...
while true
    ...
    dF = [STM(4,3), STM(4,5), dSV(4);
        STM(6,3), STM(6,5), dSV(6);
        STM(2,3), STM(2,5), dSV(2)];
