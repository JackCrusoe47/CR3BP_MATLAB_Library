function [SV0,tf] = newton_symPeriodicXY_fixedX_CR3BP(SV0_0,tf_0,mu,tol)
% =======================================================================
%   Newton-Raphson Method To Estimate Initial Condtion For Periodic
%       Orbit Symmetric Across XY plane with X-position Fixed
%                  Variable Y-position and Z-Velocity
% =======================================================================
%
...
%
% Format : [SV0,tf] = newton_symPeriodicXY_fixedX_CR3BP(SV0_0,tf_0,mu,tol)
%
% -----------------------------------------------------------------------
%                               INPUTS
% -----------------------------------------------------------------------
...
while true
    ...
    dF = [STM(5,2), STM(5,6), dSV(5);
        STM(4,2), STM(4,6), dSV(4);
