function [SV0,tf] = newton_symPeriodicX_fixedVY_CR3BP(SV0_0,tf_0,mu,tol)
% =======================================================================
%    Newton-Raphson Method To Estimate Initial Condtion For Periodic
%         Orbit Symmetric Across X-axis with Y-velocity Fixed
...
%
% Format : [SV0,tf] = newton_symPeriodicX_fixedVY_CR3BP(SV0_0,tf_0,mu,tol)
%
% -----------------------------------------------------------------------
%                               INPUTS
% -----------------------------------------------------------------------
...
while true
    ...
    dF = [STM(2,1), STM(2,6), dSV(2);
        STM(3,1), STM(3,6), dSV(3);
