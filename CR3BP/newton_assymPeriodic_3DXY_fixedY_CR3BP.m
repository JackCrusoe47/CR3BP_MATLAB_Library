function [SV0,tf] = newton_assymPeriodic_3DXY_fixedY_CR3BP(SV0_0,tf_0,mu,tol)
% =======================================================================
%     Newton-Raphson Method To Estimate Initial Condtion For Periodic
%      Orbit Assymetric and Planar in XY plane with fixed Y-position
...
%
% Format : [SV0,tf] = newton_assymPeriodic_3DXY_fixedY_CR3BP(...
%                       SV0_0,tf_0,mu,tol)
%
...
% - Selected variables (rx,rz,vx,vy,vz,tf)
X = [SV0(1);SV0(3);SV0(4);SV0(5);SV0(6);tf];
...
while true
    ...
    F = [SV(1)-SV0(1); SV(3)-SV0(3); SV(4)-SV0(4); SV(5)-SV0(5); SV(6)-SV0(6)];
    
    % -- Matrix of Partial Derivatie of Constraints wrt Free-Variables
    dF = [Q(1,1)-1, Q(1,3), Q(1,4), Q(1,5), Q(1,6), dSV(1);
        Q(3,1), Q(3,3)-1, Q(3,4), Q(3,5), Q(3,6), dSV(3);
        Q(4,1), Q(4,3), Q(4,4)-1, Q(4,5), Q(4,6), dSV(4);
        Q(5,1), Q(5,3), Q(5,4), Q(5,5)-1, Q(5,6), dSV(5);
        Q(6,1), Q(6,3), Q(6,4), Q(6,5), Q(6,6)-1, dSV(6)];
