...
SV0 = [0.9459;sqrt(3)/2;0;0.1183;-0.9595;0];
tf = 6.3201;
...
[SV0,tf] = newton_assymPeriodic_planarXY_fixedY_CR3BP(SV0,tf,mu,tol);
...
[SV0,tf] = continuation_PAL_CR3BP(SV0_origin,tf_origin,DeltaS,N,mu,4,...
    'DirectionalIncrement',true,'TargetVector',4,'TargetDirection',1);
...
save('..\database\DATASET_RAW_L4SPO_None.mat','DATASET');
