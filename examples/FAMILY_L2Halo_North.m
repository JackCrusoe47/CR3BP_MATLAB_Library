...
SV0 = [1.04527077128049,0,0.194522860351674,0,-0.148618864679492,0]';
tf = 1.82539515757449;
...
[SV0,tf] = newton_symPeriodicXZ_fixedZ_CR3BP(SV0,tf,mu,tol);
...
save('..\database\DATASET_RAW_L2Halo_North.mat','DATASET');
